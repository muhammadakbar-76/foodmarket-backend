                   ...
                   <tbody>
                       ...
                       <tr>
                        ...
                        <td class="border px-6 py-4 text-center flex">
                            <a href="{{ route("transaction.show", $item->id) }}" class="inline-block bg-blue-500 font-bold hover:bg-blue-700 text-white py-2 px-4 mx-2 rounded">View</a>
                       ...
                       @empty
                          <tr>
                              <td colspan="7" class="text-center py-3">Data empty</td>
                        </tr> 
                       @endforelse
                   </tbody>
               </table>
           </div>
           <div class="text-center mt-5">{{ $transaction->links() }}</div>
        </div>
    </div>
</x-app-layout>
